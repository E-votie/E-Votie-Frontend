                    ...
                    <form onSubmit={handleSubmit(SendOTP)}>
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" placeholder="Enter the NIC hear"
                                   className="input input-bordered w-full max-w-xs input-primary" {...register("NIC")}/>
                        </label>
                                    ...
                                    <label className="form-control w-full max-w-xs">
                                        ...
                                        <PhotoProvider>
                                            <PhotoView src={responseData.nicback}>
                                                <img style={{width: 100, height: 100}} src={responseData.nicfront} alt=""/>
                                            </PhotoView>
                                        </PhotoProvider>
                                    </label>
                                    <label className="form-control w-full max-w-xs">
                                        ...
                                        <PhotoProvider>
                                            <PhotoView src={responseData.nicback}>
                                                <img style={{width: 100, height: 100}} src={responseData.nicback} alt=""/>
                                            </PhotoView>
                                        </PhotoProvider>
                                    </label>
                                    <label className="form-control w-full max-w-xs">
                                        ...
                                        <PhotoProvider>
                                            <PhotoView src={responseData.face}>
                                                <img style={{width: 100, height: 100}} src={responseData.face} alt=""/>
                                            </PhotoView>
                                        </PhotoProvider>
                                    </label>
                                </div>
