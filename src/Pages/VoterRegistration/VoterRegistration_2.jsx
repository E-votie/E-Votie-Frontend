                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                    <div className="space-y-3">
                        ...
                        <label className="input input-bordered flex items-center gap-2 input-primary">
                            ...
                            <input type="text" value={responseData.NIC} className="grow" placeholder="NIC" {...register("NIC")} readOnly/>
                        </label>
                        <label className="input input-bordered flex items-center gap-2 input-primary">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="file" className="file-input file-input-bordered w-full max-w-xs" {...register("NICFront")}/>
                        </label>
                        {errors.NICFront && <p className="text-red-500 text-xs italic ml-5">{errors.NICFront.message}</p>}
                        <label className="form-control w-full max-w-xs">
                            <div className="label">
                                <span className="label-text">NIC Back</span>
                            </div>
                            <input type="file" className="file-input file-input-bordered w-full max-w-xs" {...register("NICBack")}/>
                        </label>
                        {errors.NICBack && <p className="text-red-500 text-xs italic ml-5">{errors.NICBack.message}</p>}
                    </div>
                    <div className="space-y-3">
                        ...
                        <div className="flex flex-col lg:flex-row w-full">
                            <select {...register("AdminDistrict")} className="select select-primary w-full max-w-xs lg:w-fit">
                                <option disabled selected>Admin District</option>
                                <option>Colombo</option>
                            </select>
                            <select {...register("ElectionDistrict")} className="select select-primary w-full max-w-xs lg:w-fit lg:ml-3">
                                <option disabled selected>Election District</option>
                                <option>Colombo</option>
                            </select>
                            <select {...register("PollingDivision")} className="select select-primary w-full max-w-xs lg:w-fit lg:ml-3">
                                <option disabled selected>Polling Division</option>
                                <option>Kesbewa</option>
                            </select>
                            <select {...register("GNDivision")} className="select select-primary w-full max-w-xs lg:w-fit lg:ml-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <label className="input input-bordered flex items-center gap-2 input-primary">
                            ...
                            <input type="text" className="grow" placeholder="Name" {...register("ChiefOccupantNIC")}/>
                        </label>
                        {errors.ChiefOccupantNIC && <p className="text-red-500 text-xs italic ml-5">{errors.ChiefOccupantNIC.message}</p>}
