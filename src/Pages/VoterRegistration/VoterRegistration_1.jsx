        ...
        <div className="flex gap-60">
            <div className="flex-initial w-96">
                <ul className="timeline timeline-vertical">
                    <li>
                        <div className="timeline-start timeline-box border-primary">Registration of Email and Mobile</div>
                    ...
                    <li>
                        ...
                        <div className="timeline-end timeline-box">Personal Details</div>
                        <hr/>
                    </li>
                    <li>
                        <hr/>
                        <div className="timeline-start timeline-box">Location Details</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        ...
                        <div className="timeline-end timeline-box">Chief Occupant Details</div>
                        <hr/>
                    </li>
                    <li>
                        <hr/>
                        <div className="timeline-start timeline-box">Conformation</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
            ...
            <div className="flex-initial w-96 space-y-3">
                ...
                <label className="input input-bordered flex items-center gap-2 input-primary">
                    ...
                    <input type="text" className="grow" placeholder="NIC"/>
                </label>
                <label className="input input-bordered flex items-center gap-2 input-primary">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
