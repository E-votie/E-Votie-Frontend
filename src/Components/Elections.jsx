      ...
      <TableRow>
        <TableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{
              'aria-label': 'select all elections',
            }}
          />
        </TableCell>
...
export const Elections = ({electionData}) => {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = electionData.map((n) => n.type);
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - electionData.length) : 0;
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={electionData.length}
            />
            <TableBody>
              {stableSort(electionData, getComparator(order, orderBy))
